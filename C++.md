...
> 
 *share_ptr*: It's usually using reference counting (count how many reference you have to this pointer, when it goes to 0 it dies. 
 [TOC](#table_of_contents)
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE4OTUwOTU1NTcsLTIwMTIyNzAxNDIsLT
